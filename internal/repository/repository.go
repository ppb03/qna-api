...
type QuestionRepository interface {
	...
	// GetByID retrieves a question from the database based on its ID.
	...
	// GetWithAnswers retrieves a question from the database based on its ID along with its associated answers.
