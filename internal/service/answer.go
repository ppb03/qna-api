...
func (s *answerService) Create(ctx context.Context, answer *models.Answer) error {
	if answer.Text == "" {
...
func (s *answerService) GetByID(ctx context.Context, id uint) (*models.Answer, error) {
